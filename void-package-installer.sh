...
# 👨‍💻 A.3.2 DEV_TOOLS
optionsList "$DEV_TOOLS" "👨‍💻  Choose Developer Tools" "CODIUM VSCODE CODEOSS SUBLIME WEBSTORM PYCHARM VIM NEOVIM NANO DOCKER NVM NODE NPM YARN TYPESCRIPT GIT GITHUB_DESKTOP"
# Ask for Git config
